...
#define _MVS_CONSTANT_REQUEST_REQ_INVALID_ARGS_ 1
...
#define _MVS_CONSTANT_REQUEST_REQ_NOT_SERVED_ 9
#define _MVS_CONSTANT_REQUEST_REQ_SERVED_ 10
#define _MVS_CONSTANT_REQUEST_REQ_INVALID_ 11
