...
union MVSEntityProperties {
	/*
	 * This represents the properties that determine the behavior of the entity in the future
	 * While config cannot be changed once set, properties can be changed 
	 */
	 struct {
	 	mqword_t resb;
	 }_;
