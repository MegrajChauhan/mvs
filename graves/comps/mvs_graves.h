...
struct MVSGraves {
	...
	MVSDynamicListLinear *entity_list; // all of the entities; active and non-active
    MVSRequestQueueManager* req_queue;

    MVSGravesAPI local_API;    // For Local entities(I will need to define another one for external entities)
};
...
/*
 * Here, i have decided to expose the functions that comprise Manager API for the entities.
 */
