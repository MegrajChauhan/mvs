 ...
 * RLIST loads these entities and provides a way for MVS to acccess them.
 * MVS expects an entities.l list file at launch which is read to load a few of the entities
