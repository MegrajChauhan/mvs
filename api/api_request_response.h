...
enum apiReqResponse_t {
  ...
  API_REQ_RESPONSE_NOT_PERMITTED, // The request isn't allowed or some operation
                                  // required by the request isn't allowed
  ...
  API_REQ_RESPONSE_INVALID_SETUP, // The provided setup for the entity launch is
                                  // invalid
  ...
  API_REQ_RESPONSE_INVALID_DATA,       // The data provided for some request was
                                       // invalid
  API_REQ_RESPONSE_RESOURCE_EXHAUSTED, // The resource used by the request has
                                       // been exhausted
  API_REQ_RESPONSE_RESOURCE_INVALID_STATE, // The resource used by the request
                                           // is in an invalid state such that
                                           // either any operation is impossible
                                           // or just this operation is
                                           // impossible
